...
function displayModels(models) {
    ...
    models.forEach(model => {
        ...
        card.className = 'model-tile flex flex-col flex-shrink-0 w-[90%] sm:w-[60%] md:w-[28%] rounded-lg overflow-hidden snap-center group mx-auto pb-6 transition transform duration-300 hover:scale-[1.03] border border-white border-opacity-10';
