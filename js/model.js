  ...
  modelDetailsEl.innerHTML = `
    ...
    <div class="w-full space-y-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-10">
        ...
        <div class="lg:col-span-2 rounded-3xl border border-white/20 p-6 bg-transparent flex flex-col justify-between">
          ...
          <!-- MOBILE IMAGE -->
          <div class="block lg:hidden w-full rounded-xl py-2 h-[220px]">
            ...
            <ul class="space-y-3 mb-6">
              ${model.features.map(f => `
                <li class="flex items-start gap-3">
                  <span class="flex items-center justify-center w-4 h-4 rounded-full mt-1 bg-blue-500">
