// background.js — injects page-specific backgrounds (base) + shared waves
    ...
    <div class="absolute inset-0 opacity-[0.45]">
      <div class="ocean-wave ocean-wave--top">
        <svg viewBox="0 0 1440 320" preserveAspectRatio="none">
          <path
            class="ocean-wave-path ocean-wave-path--top"
            d="M0,160L48,144C96,128,192,96,288,90.7C384,85,480,107,576,138.7C672,171,768,213,864,229.3C960,245,1056,235,1152,218.7C1248,203,1344,181,1392,170.7L1440,160"
          />
        </svg>
      </div>
      ...
      <div class="ocean-wave ocean-wave--mid">
        <svg viewBox="0 0 1440 320" preserveAspectRatio="none">
          <path
            class="ocean-wave-path ocean-wave-path--mid"
      ...
      <div class="ocean-wave ocean-wave--deep">
        <svg viewBox="0 0 1440 320" preserveAspectRatio="none">
          <path
            class="ocean-wave-path ocean-wave-path--deep"
